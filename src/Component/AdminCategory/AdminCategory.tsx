...
//     categoryName: Yup.string().min(3, 'category is too short').max(20, 'category is too long').required('category is required'),
...
//     const { data } = await axios.delete(`http://localhost:5000/category/${id}`, config);
//     if (data.status === 'success') {
...
//               type="text"
//               name="categoryName"
//               value={categoryForm.values.categoryName}
//               onChange={categoryForm.handleChange}
//               onBlur={categoryForm.handleBlur}
//             />
//               {categoryForm.errors.categoryName && categoryForm.touched.categoryName && (
//                 <Alert variant="danger">{categoryForm.errors.categoryName}</Alert>
//               )}
//           </Form.Group>
...
//               onBlur={categoryForm.handleBlur}
//             />
//               {categoryForm.errors.categoryImage && categoryForm.touched.categoryImage && (
//                 <Alert variant="danger">{categoryForm.errors.categoryImage}</Alert>
//               )}
//           </Form.Group>
...
//               type="text"
//               name="createdBy"
//               value={categoryForm.values.createdBy}
//               onChange={categoryForm.handleChange}
//               onBlur={categoryForm.handleBlur}
//             />

//               {categoryForm.errors.createdBy && categoryForm.touched.createdBy && (
...
// <h1 className='text-center text-success m-5'>All Category In your Store</h1>
...
//     onClick={() => handleDeleteCategory(category._id)}></i>
// </td>
